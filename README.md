...
2. **The three detectors of v01**, all between 0 and 1: `flach_v01` from the spread of the readings, `aufsetzen_v01` for a step of more than 1.5 g from one reading to the next, and `mahlen_v01` from the rate of a straight line over the last readings - and 0 wherever the weight is really moving by less than 1 g/s and the value has not made it past 0.6. Two dark bars say what really happened - a centred average, which looks as far forward as backward and therefore knows the real course of the weight, marks where the scale was standing and where it was moving.
