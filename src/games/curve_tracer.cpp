...
#define TRACER_SPEED_INCREASE 0.6f      // ... increasing by this every second ...
#define TRACER_SPEED_MAX 60.0f          // ... up to this
#define TRACER_TOLERANCE_START 20.0f    // allowed deviation from the line in grams at the start ...
#define TRACER_TOLERANCE_DECREASE 0.05f // ... shrinking by this every second ...
#define TRACER_TOLERANCE_MIN 10.0f      // ... down to this
#define TRACER_LATENCY_MS 200           // the pen lags behind the finger, so it may match the line of this long ago
#define TRACER_SHAPE_TIME 120.0f        // seconds until ramps are steepest and waves highest and shortest
