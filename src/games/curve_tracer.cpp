...
#define TRACER_SPEED_INCREASE 1.1f      // ... increasing by this every second ...
#define TRACER_SPEED_MAX 75.0f          // ... up to this, reached after 50 seconds
#define TRACER_TOLERANCE_START 20.0f    // allowed deviation from the line in grams at the start ...
#define TRACER_TOLERANCE_DECREASE 0.067f // ... shrinking by this every second ...
#define TRACER_TOLERANCE_MIN 10.0f      // ... down to this, reached after 150 seconds
#define TRACER_LATENCY_MS 200           // the pen lags behind the finger, so it may match the line of this long ago
#define TRACER_SHAPE_TIME 90.0f         // seconds until ramps are steepest and waves highest and shortest
