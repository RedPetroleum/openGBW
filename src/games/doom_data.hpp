...
// Sprites, font and level of Doom, only included by doom.cpp
//
// Taken from doom-nano by daveruiz (https://github.com/daveruiz/doom-nano, commit 2346404):
// the AVR specific PROGMEM storage removed, the font and level macros renamed. In the level one of the two locked
// doors of the room with the key on the left is a normal door, otherwise the last key could be spent on it.
// Bitmaps have one bit per pixel, the highest bit is the leftmost pixel.

#define DOOM_LEVEL_WIDTH_BASE 6
#define DOOM_LEVEL_WIDTH (1 << DOOM_LEVEL_WIDTH_BASE)
#define DOOM_LEVEL_HEIGHT 57
#define DOOM_LEVEL_BYTES DOOM_LEVEL_WIDTH / 2 * DOOM_LEVEL_HEIGHT

#define FONT_BYTES_PER_ROW   24  // in bytes
#define FONT_ROWS  6
#define FONT_CHAR_MAP         " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ.,-_(){}[]#"
...
*/
const static uint8_t level1[DOOM_LEVEL_BYTES] = {
  ...
  0xF0, 0x00, 0x04, 0x00, 0x00, 0x90, 0x00, 0x0F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x20, 0x00, 0x04, 0x00, 0x00, 0x20, 0x00, 0xFF, 
